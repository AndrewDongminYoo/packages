...
class AdErrorProxyApi(
    ...
    override fun errorCodeNumber(pigeon_instance: AdError): Long = pigeon_instance.errorCodeNumber.toLong()
    ...
    override fun message(pigeon_instance: AdError): String = pigeon_instance.message
}
