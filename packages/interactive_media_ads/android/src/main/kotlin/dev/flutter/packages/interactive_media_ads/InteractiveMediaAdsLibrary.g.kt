...
class InteractiveMediaAdsLibraryPigeonInstanceManager(
    ...
    companion object {
        ...
        fun create(finalizationListener: PigeonFinalizationListener): InteractiveMediaAdsLibraryPigeonInstanceManager =
            InteractiveMediaAdsLibraryPigeonInstanceManager(finalizationListener)
    }
     ...
     */
    fun hasFinalizationListenerStopped(): Boolean = hasFinalizationListenerStopped
...
abstract class InteractiveMediaAdsLibraryPigeonProxyApiRegistrar(
     ...
     */
    open fun getPigeonApiBaseDisplayContainer(): PigeonApiBaseDisplayContainer = PigeonApiBaseDisplayContainer(this)
     ...
     */
    open fun getPigeonApiAdDisplayContainer(): PigeonApiAdDisplayContainer = PigeonApiAdDisplayContainer(this)
     ...
     */
    open fun getPigeonApiContentProgressProvider(): PigeonApiContentProgressProvider = PigeonApiContentProgressProvider(this)
     ...
     */
    open fun getPigeonApiImaSdkSettings(): PigeonApiImaSdkSettings = PigeonApiImaSdkSettings(this)
     ...
     * `InstanceManager`.
     */
    open fun getPigeonApiView(): PigeonApiView = PigeonApiView(this)
    ...
    fun setUp() {
        ...
        PigeonApiVideoProgressUpdate.setUpMessageHandlers(
            binaryMessenger,
            getPigeonApiVideoProgressUpdate(),
        )
...
enum class AdErrorCode(
    ...
    companion object {
        fun ofRaw(raw: Int): AdErrorCode? = values().firstOrNull { it.raw == raw }
    }
}
...
enum class AdErrorType(
    ...
    companion object {
        fun ofRaw(raw: Int): AdErrorType? = values().firstOrNull { it.raw == raw }
    }
}
...
enum class AdEventType(
    ...
    companion object {
        fun ofRaw(raw: Int): AdEventType? = values().firstOrNull { it.raw == raw }
    }
}
...
open class PigeonApiAdDisplayContainer(
    ...
    fun pigeon_getPigeonApiBaseDisplayContainer(): PigeonApiBaseDisplayContainer = pigeonRegistrar.getPigeonApiBaseDisplayContainer()
}
...
abstract class PigeonApiAdsManager(
    ...
    @Suppress("FunctionName")
    fun pigeon_getPigeonApiBaseManager(): PigeonApiBaseManager = pigeonRegistrar.getPigeonApiBaseManager()
}
...
abstract class PigeonApiVideoProgressUpdate(
    ...
    companion object {
        ...
        fun setUpMessageHandlers(
            binaryMessenger: BinaryMessenger,
            api: PigeonApiVideoProgressUpdate?,
        ) {
            val codec = api?.pigeonRegistrar?.codec ?: StandardMessageCodec()
            run {
                val channel =
...
abstract class PigeonApiFrameLayout(
    ...
    @Suppress("FunctionName")
    fun pigeon_getPigeonApiViewGroup(): PigeonApiViewGroup = pigeonRegistrar.getPigeonApiViewGroup()
}
...
abstract class PigeonApiViewGroup(
    ...
    abstract fun addView(
        pigeon_instance: android.view.ViewGroup,
    ...
    @Suppress("FunctionName")
    fun pigeon_getPigeonApiView(): PigeonApiView = pigeonRegistrar.getPigeonApiView()
}
...
open class PigeonApiView(
    ...
    @Suppress("LocalVariableName", "FunctionName")
    fun pigeon_newInstance(
        pigeon_instanceArg: android.view.View,
        callback: (Result<Unit>) -> Unit,
    ) {
        if (pigeonRegistrar.ignoreCallsToDart) {
            callback(
...
abstract class PigeonApiVideoAdPlayerCallback(
    ...
    abstract fun onAdProgress(
        pigeon_instance: com.google.ads.interactivemedia.v3.api.player.VideoAdPlayer.VideoAdPlayerCallback,
    ...
    @Suppress("LocalVariableName", "FunctionName")
    fun pigeon_newInstance(
        pigeon_instanceArg: com.google.ads.interactivemedia.v3.api.player.VideoAdPlayer.VideoAdPlayerCallback,
        callback: (Result<Unit>) -> Unit,
    ) {
        if (pigeonRegistrar.ignoreCallsToDart) {
            callback(
...
abstract class PigeonApiVideoAdPlayer(
    ...
    fun addCallback(
        pigeon_instanceArg: com.google.ads.interactivemedia.v3.api.player.VideoAdPlayer,
        callbackArg: com.google.ads.interactivemedia.v3.api.player.VideoAdPlayer.VideoAdPlayerCallback,
        callback: (Result<Unit>) -> Unit,
    ) {
        if (pigeonRegistrar.ignoreCallsToDart) {
            callback(
...
abstract class PigeonApiAdsLoadedListener(
    ...
    companion object {
        ...
        fun setUpMessageHandlers(
            binaryMessenger: BinaryMessenger,
            api: PigeonApiAdsLoadedListener?,
        ) {
            val codec = api?.pigeonRegistrar?.codec ?: StandardMessageCodec()
            run {
                val channel =
