...
class TestPlugin :
    ...
    override fun echoAllTypes(everything: AllTypes): AllTypes = everything

    override fun echoAllNullableTypes(everything: AllNullableTypes?): AllNullableTypes? = everything

    override fun echoAllNullableTypesWithoutRecursion(everything: AllNullableTypesWithoutRecursion?): AllNullableTypesWithoutRecursion? =
        everything

    override fun throwError(): Any? = throw Exception("An error")

    override fun throwErrorFromVoid(): Unit = throw Exception("An error")

    override fun throwFlutterError(): Any? = throw FlutterError("code", "message", "details")

    override fun echoInt(anInt: Long): Long = anInt

    override fun echoDouble(aDouble: Double): Double = aDouble

    override fun echoBool(aBool: Boolean): Boolean = aBool

    override fun echoString(aString: String): String = aString

    override fun echoUint8List(aUint8List: ByteArray): ByteArray = aUint8List

    override fun echoObject(anObject: Any): Any = anObject

    override fun echoList(list: List<Any?>): List<Any?> = list

    override fun echoMap(map: Map<Any?, Any?>): Map<Any?, Any?> = map

    override fun echoStringMap(stringMap: Map<String?, String?>): Map<String?, String?> = stringMap

    override fun echoIntMap(intMap: Map<Long?, Long?>): Map<Long?, Long?> = intMap

    override fun echoClassWrapper(wrapper: AllClassesWrapper): AllClassesWrapper = wrapper

    override fun echoEnum(anEnum: AnEnum): AnEnum = anEnum

    override fun echoAnotherEnum(anotherEnum: AnotherEnum): AnotherEnum = anotherEnum

    override fun echoNamedDefaultString(aString: String): String = aString

    override fun echoOptionalDefaultDouble(aDouble: Double): Double = aDouble

    override fun echoRequiredInt(anInt: Long): Long = anInt

    override fun extractNestedNullableString(wrapper: AllClassesWrapper): String? = wrapper.allNullableTypes.aNullableString

    override fun createNestedNullableString(nullableString: String?): AllClassesWrapper =
        AllClassesWrapper(AllNullableTypes(aNullableString = nullableString))
    ...
    override fun echoNullableInt(aNullableInt: Long?): Long? = aNullableInt

    override fun echoNullableDouble(aNullableDouble: Double?): Double? = aNullableDouble

    override fun echoNullableBool(aNullableBool: Boolean?): Boolean? = aNullableBool

    override fun echoNullableString(aNullableString: String?): String? = aNullableString

    override fun echoNullableUint8List(aNullableUint8List: ByteArray?): ByteArray? = aNullableUint8List

    override fun echoNullableObject(aNullableObject: Any?): Any? = aNullableObject

    override fun echoNullableList(aNullableList: List<Any?>?): List<Any?>? = aNullableList

    override fun echoNullableMap(map: Map<Any?, Any?>?): Map<Any?, Any?>? = map

    override fun echoNullableStringMap(stringMap: Map<String?, String?>?): Map<String?, String?>? = stringMap

    override fun echoNullableIntMap(intMap: Map<Long?, Long?>?): Map<Long?, Long?>? = intMap

    override fun echoNullableEnum(anEnum: AnEnum?): AnEnum? = anEnum

    override fun echoAnotherNullableEnum(anotherEnum: AnotherEnum?): AnotherEnum? = anotherEnum

    override fun echoOptionalNullableInt(aNullableInt: Long?): Long? = aNullableInt

    override fun echoNamedNullableString(aNullableString: String?): String? = aNullableString
    ...
    override fun echoAsyncAllTypes(
        everything: AllTypes,
    ...
    override fun callFlutterEchoAllTypes(
        everything: AllTypes,
        callback: (Result<AllTypes>) -> Unit,
    ) {
    ...
    override fun callFlutterSmallApiEchoString(
        aString: String,
        callback: (Result<String>) -> Unit,
    ) {
