...
class SharedPreferencesPlugin() :
    ...
    override fun setString(
        ...
        value: String,
        options: SharedPreferencesPigeonOptions,
    ) = runBlocking { dataStoreSetString(key, value) }

    private suspend fun dataStoreSetString(
        key: String,
        value: String,
    ) {
    ...
    override fun getAll(
        allowList: List<String>?,
        options: SharedPreferencesPigeonOptions,
    ): Map<String, Any> = runBlocking { getPrefs(allowList) }
    ...
    override fun getStringList(
        key: String,
        options: SharedPreferencesPigeonOptions,
    ): List<String>? = (transformPref(getString(key, options) as Any?) as List<*>?)?.filterIsInstance<String>()
